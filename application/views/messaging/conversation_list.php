...
<div class="col-md-12">
	<a class="btn btn-opp" href="<?php echo base_url('messaging/start_conversation_with'); ?>"><i class='fa fa-phone'>&nbsp;</i>Initiate Conversation</a><br /> <small>(Note: This is only use for testing and will be removed once it goes live);</small>
</div>
